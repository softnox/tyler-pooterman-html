                                    ...
                                    <div className="slider-content">
                                                        ...
                                                        <form method="post">
                                                            <div className="wd-find-select style-2">
                                                                ...
                                                                <div className="box-btn-advanced">
                                                                    ...
                                                                    <button type="submit" className="tf-btn btn-search primary">Search <i className="icon icon-search"></i> </button>
                                                                </div>
                                        ...
                                        <div className="wrap-search-link">
                                            ...
                                            <div className="categories-list">
                                                <a href="#"><i className="icon icon-house-fill"></i> Houses</a>
                                                <a href="#"><i className="icon icon-villa-fill"></i> Villa</a>
                                                <a href="#"><i className="icon icon-office-fill"></i> Office</a>
                                                <a href="#"><i className="icon icon-apartment"></i> Apartments</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
