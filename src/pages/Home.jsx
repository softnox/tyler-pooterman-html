                ...
                <div id="pagee" className="clearfix">
                    ...
                    <section className="flat-slider home-2 bg-primary-new">
                        <div className="container relative">
                                    ...
                                    <div className="slider-content">
                                        <div className="heading">
                                            <h1 className="fw-8 title animationtext clip">
                                                Access Verified Property
                                                <br />
                                                <span className="tf-text s1 cd-words-wrapper">
                                                    <span className="item-text is-visible">Service History</span>
                                                    <span className="item-text is-hidden">Service History</span>
                                                    <span className="item-text is-hidden">Service History</span>
                                                </span>
                                            </h1>
                                            <p className="subtitle body-2 wow fadeInUp" data-wow-delay=".2s">
                                                Search secure and verified property service records, manage reports, and unlock <br /> valuable insights for homeowners, buyers, and real estate professionals.
                                            </p>
                                        </div>
                                        <div className="flat-tab flat-tab-form">
                                            <ul className="nav-tab-form style-2" role="tablist">
                                                <li className="nav-tab-item" role="presentation">
                                                    <a href="#forRent" className="nav-link-item active" data-bs-toggle="tab">Search Property History</a>
                                                </li>
                                                <li className="nav-tab-item" role="presentation">
                                                    <a href="#forSale" className="nav-link-item" data-bs-toggle="tab">Upload Service Record</a>
                                                </li>
                                            </ul>
                                                                ...
                                                                <div className="box-btn-advanced">
                                                                    <div className="form-group-4 box-filter">
                                                                        <a className="tf-btn btn-line filter-advanced pull-right">
                                                                            <span className="text-1">Advanced Filters</span>
                                                                    ...
                                                                    <button type="submit" className="tf-btn btn-search primary">Search Records<i className="icon icon-search"></i> </button>
                                                                </div>
                                        ...
                                        <div className="wrap-search-link">
                                            <p className="body-2 mb-3">What are you looking for:</p>
                                            <div className="categories-list">
                                                <a href="#"><i className="icon icon-house-fill"></i>Plumbing</a>
                                                <a href="#"><i className="icon icon-villa-fill"></i>HVAC</a>
                                                <a href="#"><i className="icon icon-office-fill"></i>Electrical</a>
                                                <a href="#"><i className="icon icon-apartment"></i>Roofing</a>
                                                <a href="#"><i className="icon icon-house-fill"></i>Repairs</a>
                                                <a href="#"><i className="icon icon-villa-fill"></i>Maintenance</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="img-banner-left">
                                <img src="https://homelengo.vercel.app/images/slider/graplic-slider-2.png" alt="img" />
                            </div>
                                    ...
                                    <div className="swiper-wrapper">
                                        <div className="swiper-slide">
                                            <div className="slider-home2 img-animation wow">
                                                <img src="https://homelengo.vercel.app/images/slider/slider-2.jpg" alt="images" />
                                            </div>
                                        </div>
                                        <div className="swiper-slide">
                                            <div className="slider-home2">
                                                <img src="https://homelengo.vercel.app/images/slider/slider-2-1.jpg" alt="images" />
                                            </div>
                                        </div>

                                        <div className="swiper-slide">
                                            <div className="slider-home2">
                                                <img src="https://homelengo.vercel.app/images/slider/slider-2-3.jpg" alt="images" />
                                            </div>
                                        </div>
                    ...
                    <section className="flat-section flat-recommended pt-0">
                        <div className="container">
                            <div className="box-title text-center wow fadeInUp">
                                ...
                                <h3 className="title mt-4">Discover Homelengo's Finest Properties
                                    for Your Dream Home</h3>
                            </div>
                                ...
                                <div className="tab-content">
                                    <div className="tab-pane" id="viewAll" role="tabpanel">
                                                ...
                                                <div className="homelengo-box">
                                                    <div className="archive-top">
                                                        <a href="property-details-v1.html" className="images-group">
                                                            <div className="images-style">
                                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/home/house-13.jpg" src="https://homelengo.vercel.app/images/home/house-13.jpg" alt="img" />
                                                            </div>
                                                            <div className="top">
                                                    ...
                                                    <div className="archive-bottom">
                                                        <div className="content-top">
                                                            <h6 className="text-capitalize"><a href="property-details-v1.html" className="link"> Casa Lomas de Machalí Machas</a></h6>
                                                        ...
                                                        <div className="content-bottom">
                                                            <div className="d-flex gap-8 align-items-center">
                                                                <div className="avatar avt-40 round">
                                                                    <img src="https://homelengo.vercel.app/images/avatar/avt-png1.png" alt="avt" />
                                                                </div>
                                            ...
                                            <div className="col-xl-4 col-lg-6 col-md-6">
                                                <div className="homelengo-box">
                                                    <div className="archive-top">
                                                        <a href="property-details-v1.html" className="images-group">
                                                            <div className="images-style">
                                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/home/house-14.jpg" src="https://homelengo.vercel.app/images/home/house-14.jpg" alt="img" />
                                                            </div>
                                                            <div className="top">
                                                                <ul className="d-flex gap-6">
                                                                    <li className="flag-tag primary">Featured</li>
                                                    ...
                                                    <div className="archive-bottom">
                                                        ...
                                                        <div className="content-bottom">
                                                            <div className="d-flex gap-8 align-items-center">
                                                                <div className="avatar avt-40 round">
                                                                    <img src="https://homelengo.vercel.app/images/avatar/avt-png2.png" alt="avt" />
                                                                </div>
                                                                <span>Arlene McCoy</span>
                                                            </div>
                                                            <h6 className="price">$7250,00</h6>
                                            ...
                                            <div className="col-xl-4 col-lg-6 col-md-6">
                                                <div className="homelengo-box">
                                                    <div className="archive-top">
                                                        <a href="property-details-v1.html" className="images-group">
                                                            <div className="images-style">
                                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/home/house-15.jpg" src="https://homelengo.vercel.app/images/home/house-15.jpg" alt="img" />
                                                            </div>
                                                            <div className="top">
                                                                <ul className="d-flex gap-6">
                                                                    <li className="flag-tag primary">Featured</li>
                                                    ...
                                                    <div className="archive-bottom">
                                                        ...
                                                        <div className="content-bottom">
                                                            <div className="d-flex gap-8 align-items-center">
                                                                <div className="avatar avt-40 round">
                                                                    <img src="https://homelengo.vercel.app/images/avatar/avt-png3.png" alt="avt" />
                                                                </div>
                                                                <span>Arlene McCoy</span>
                                                            </div>
                                                            <h6 className="price">$7250,00</h6>
                                            ...
                                            <div className="col-xl-4 col-lg-6 col-md-6">
                                                <div className="homelengo-box">
                                                    <div className="archive-top">
                                                        <a href="property-details-v1.html" className="images-group">
                                                            <div className="images-style">
                                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/home/house-16.jpg" src="https://homelengo.vercel.app/images/home/house-16.jpg" alt="img" />
                                                            </div>
                                                            <div className="top">
                                                                <ul className="d-flex gap-6">
                                                                    <li className="flag-tag primary">Featured</li>
                                                    ...
                                                    <div className="archive-bottom">
                                                        ...
                                                        <div className="content-bottom">
                                                            <div className="d-flex gap-8 align-items-center">
                                                                <div className="avatar avt-40 round">
                                                                    <img src="https://homelengo.vercel.app/images/avatar/avt-png4.png" alt="avt" />
                                                                </div>
                                                                <span>Arlene McCoy</span>
                                                            </div>
                                                            <h6 className="price">$7250,00</h6>
                                            ...
                                            <div className="col-xl-4 col-lg-6 col-md-6">
                                                <div className="homelengo-box">
                                                    <div className="archive-top">
                                                        <a href="property-details-v1.html" className="images-group">
                                                            <div className="images-style">
                                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/home/house-17.jpg" src="https://homelengo.vercel.app/images/home/house-17.jpg" alt="img" />
                                                            </div>
                                                            <div className="top">
                                                                <ul className="d-flex gap-6">
                                                                    <li className="flag-tag primary">Featured</li>
                                                    ...
                                                    <div className="archive-bottom">
                                                        ...
                                                        <div className="content-bottom">
                                                            <div className="d-flex gap-8 align-items-center">
                                                                <div className="avatar avt-40 round">
                                                                    <img src="https://homelengo.vercel.app/images/avatar/avt-png5.png" alt="avt" />
                                                                </div>
                                                                <span>Arlene McCoy</span>
                                                            </div>
                                                            <h6 className="price">$7250,00</h6>
                                            ...
                                            <div className="col-xl-4 col-lg-6 col-md-6">
                                                <div className="homelengo-box">
                                                    <div className="archive-top">
                                                        <a href="property-details-v1.html" className="images-group">
                                                            <div className="images-style">
                                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/home/house-18.jpg" src="https://homelengo.vercel.app/images/home/house-18.jpg" alt="img" />
                                                            </div>
                                                            <div className="top">
                                                                <ul className="d-flex gap-6">
                                                                    <li className="flag-tag primary">Featured</li>
                                                    ...
                                                    <div className="archive-bottom">
                                                        ...
                                                        <div className="content-bottom">
                                                            <div className="d-flex gap-8 align-items-center">
                                                                <div className="avatar avt-40 round">
                                                                    <img src="https://homelengo.vercel.app/images/avatar/avt-png6.png" alt="avt" />
                                                                </div>
                                                                <span>Arlene McCoy</span>
                                                            </div>
                                                            <h6 className="price">$7250,00</h6>
                                        ...
                                        <div className="text-center">
                                            <a href="sidebar-grid.html" className="tf-btn btn-view primary size-1 hover-btn-view">View All Properties <span className="icon icon-arrow-right2"></span></a>
                                        </div>
                                    </div>
                            ...
                            <div className="flat-img-with-text-v2">
                                    ...
                                    <div className="grid-img-group">
                                        <div className="tf-image-wrap item-1">
                                            <div className="img-style hover-img-wrap">
                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/banner/img-w-text-sm1.jpg" src="https://homelengo.vercel.app/images/banner/img-w-text-sm1.jpg" alt="" />
                                            </div>
                                        ...
                                        <div className="tf-image-wrap item-2">
                                            <div className="img-style hover-img-wrap">
                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/banner/img-w-text2.jpg" src="https://homelengo.vercel.app/images/banner/img-w-text2.jpg" alt="" />
                                            </div>
                                        ...
                                        <div className="tf-image-wrap item-3">
                                            <div className="img-style hover-img-wrap">
                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/banner/img-w-text-sm2.jpg" src="https://homelengo.vercel.app/images/banner/img-w-text-sm2.jpg" alt="" />
                                            </div>
                                ...
                                <div className="content-right">
                                    <div className="box-title wow fadeInUp">
                                        ...
                                        <h3 className="title mt-4">Discover what sets our Real Estate expertise apart</h3>
                                        <p className="desc text-variant-1">Our seasoned professionals, armed with extensive market knowledge, walk alongside you through every phase of your property endeavor.</p>
                                    </div>
                                    <div className="flat-service wow fadeInUp" data-wow-delay=".2s">
                                        <a href="#" className="box-benefit hover-btn-view">
                                            ...
                                            <div className="content">
                                                ...
                                                <span className="btn-view style-1"><span className="text">Explore Now</span> <span className="icon icon-arrow-right2"></span> </span>
                                            </div>
                                        </a>
                                        <a href="#" className="box-benefit hover-btn-view">
                                            <div className="icon-box">
                                                <span className="icon">
                                                    <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g clipPath="url(#clip0_13434_4244)">
                                                            ...
                                                            <path d="M53.25 19.3125C55.875 18 57.9375 15.5625 58.5 12.4687C59.5312 7.21875 56.1562 2.15625 50.9062 1.125C45.6562 0.0937479 40.5937 3.46875 39.5625 8.71875V8.8125C39 11.7187 39.8437 14.625 41.5312 16.7812" stroke="#1563DF" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                                        </g>
                                                        <defs>
                                                ...
                                                <span className="icon">
                                                    <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g clipPath="url(#clip0_13434_4259)">
                                                            ...
                                                            <path d="M22.6875 46.2188V48.0938" stroke="#1563DF" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                                                        </g>
                                                        <defs>
                    ...
                    <section className="flat-section flat-location-v2">
                        <div className="container">
                            ...
                            <div className="grid-location wow fadeInUp" data-wow-delay=".2s">
                                <a href="topmap-grid.html" className="item-1 box-location-v2 hover-img">
                                    <div className="box-img img-style">
                                        <img className="lazyload" data-src="https://homelengo.vercel.app/images/location/location-7.jpg" src="https://homelengo.vercel.app/images/location/location-7.jpg" alt="image-location" />
                                    </div>
                                    <div className="content">
                                ...
                                <a href="topmap-grid.html" className="item-2 box-location-v2 hover-img">
                                    <div className="box-img img-style">
                                        <img className="lazyload" data-src="https://homelengo.vercel.app/images/location/location-8.jpg" src="https://homelengo.vercel.app/images/location/location-8.jpg" alt="image-location" />
                                    </div>
                                    <div className="content">
                                ...
                                <a href="#" className="item-3 box-location-v2 hover-img">
                                    <div className="box-img img-style">
                                        <img className="lazyload" data-src="https://homelengo.vercel.app/images/location/location-9.jpg" src="https://homelengo.vercel.app/images/location/location-9.jpg" alt="image-location" />
                                    </div>
                                    <div className="content">
                                ...
                                <a href="#" className="item-4 box-location-v2 hover-img">
                                    <div className="box-img img-style">
                                        <img className="lazyload" data-src="https://homelengo.vercel.app/images/location/location-10.jpg" src="https://homelengo.vercel.app/images/location/location-10.jpg" alt="image-location" />
                                    </div>
                                    <div className="content">
                                ...
                                <a href="topmap-grid.html" className="item-5 box-location-v2 hover-img">
                                    <div className="box-img img-style">
                                        <img className="lazyload" data-src="https://homelengo.vercel.app/images/location/location-11.jpg" src="https://homelengo.vercel.app/images/location/location-11.jpg" alt="image-location" />
                                    </div>
                                    <div className="content">
                                ...
                                <a href="topmap-grid.html" className="item-6 box-location-v2 hover-img">
                                    <div className="box-img img-style">
                                        <img className="lazyload" data-src="https://homelengo.vercel.app/images/location/location-12.jpg" src="https://homelengo.vercel.app/images/location/location-12.jpg" alt="image-location" />
                                    </div>
                                    <div className="content">
                    ...
                    <section className="flat-section bg-primary-new">
                        <div className="container">
                            ...
                            <div dir="ltr" className="swiper tf-sw-mobile" data-screen="991" data-preview="1" data-space="15">
                                <div className="tf-layout-mobile-lg lg-col-2 swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="homelengo-box list-style-1 wow fadeInUp" data-wow-delay=".1s">
                                            <div className="archive-top">
                                                <a href="property-details-v1.html" className="images-group">
                                                    <div className="images-style">
                                                        <img className="lazyload" data-src="https://homelengo.vercel.app/images/home/house-sm-1.jpg" src="https://homelengo.vercel.app/images/home/house-sm-1.jpg" alt="img-property" />
                                                    </div>
                                                    <div className="top">
                                            ...
                                            <div className="archive-bottom">
                                                <div className="content-top">
                                                    <h6 className="text-capitalize"><a href="property-details-v1.html" className="link text-line-clamp-1"> Casa Lomas de Machalí Machas</a></h6>
                                                    <ul className="meta-list">
                                                        <li className="item">
                                                            <i className="icon icon-bed"></i>
                                                            <span className="text-variant-1">Beds:</span>
                                    ...
                                    <div className="swiper-slide">
                                        <div className="homelengo-box list-style-1 wow fadeInUp" data-wow-delay=".2s">
                                            <div className="archive-top">
                                                <a href="property-details-v1.html" className="images-group">
                                                    <div className="images-style">
                                                        <img className="lazyload" data-src="https://homelengo.vercel.app/images/home/house-sm-2.jpg" src="https://homelengo.vercel.app/images/home/house-sm-2.jpg" alt="img-property" />
                                                    </div>
                                                    <div className="top">
                                                        <ul className="d-flex gap-6 flex-wrap">
                                                            <li className="flag-tag primary">Featured</li>
                                    ...
                                    <div className="swiper-slide">
                                        <div className="homelengo-box list-style-1 wow fadeInUp" data-wow-delay=".3s">
                                            <div className="archive-top">
                                                <a href="property-details-v1.html" className="images-group">
                                                    <div className="images-style">
                                                        <img className="lazyload" data-src="https://homelengo.vercel.app/images/home/house-sm-3.jpg" src="https://homelengo.vercel.app/images/home/house-sm-3.jpg" alt="img-property" />
                                                    </div>
                                                    <div className="top">
                                                        <ul className="d-flex gap-6 flex-wrap">
                                                            <li className="flag-tag primary">Featured</li>
                                    ...
                                    <div className="swiper-slide">
                                        <div className="homelengo-box list-style-1 wow fadeInUp" data-wow-delay=".4s">
                                            <div className="archive-top">
                                                <a href="property-details-v1.html" className="images-group">
                                                    <div className="images-style">
                                                        <img className="lazyload" data-src="https://homelengo.vercel.app/images/home/house-sm-4.jpg" src="https://homelengo.vercel.app/images/home/house-sm-4.jpg" alt="img-property" />
                                                    </div>
                                                    <div className="top">
                                                        <ul className="d-flex gap-6 flex-wrap">
                                                            <li className="flag-tag primary">Featured</li>
                        ...
                        <div className="container">
                            ...
                            <div dir="ltr" className="swiper tf-sw-mobile-1" data-screen="575" data-preview="1" data-space="15">
                                <div className="tf-layout-mobile-sm xl-col-4 sm-col-2 swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="box-agent hover-img wow fadeInUp" data-wow-delay=".2s">
                                            <a href="#" className="box-img img-style">
                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/agents/agent-5.jpg" src="https://homelengo.vercel.app/images/agents/agent-5.jpg" alt="image-agent" />
                                            ...
                                            <div className="content">
                                                <div className="info">
                                                    <h5><a className="link" href="#">Chris Patt</a></h5>
                                                    <p className="text-variant-1">Administrative Staff</p>
                                                </div>
                                    ...
                                    <div className="swiper-slide">
                                        <div className="box-agent hover-img wow fadeInUp" data-wow-delay=".3s">
                                            <a href="#" className="box-img img-style">
                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/agents/agent-6.jpg" src="https://homelengo.vercel.app/images/agents/agent-6.jpg" alt="image-agent" />
                                                <ul className="agent-social">
                                                    <li><span className="icon icon-facebook"></span></li>
                                                    <li><span className="icon icon-x"></span></li>
                                                    <li><span className="icon icon-linkedin"></span></li>
                                            ...
                                            <div className="content">
                                                <div className="info">
                                                    <h5><a className="link" href="#">Marvin McKinney</a></h5>
                                                    <p className="text-variant-1">Administrative Staff</p>
                                                </div>
                                                <div className="box-icon">
                                                    <span className="icon icon-phone"></span>
                                    ...
                                    <div className="swiper-slide">
                                        <div className="box-agent hover-img wow fadeInUp" data-wow-delay=".4s">
                                            <a href="#" className="box-img img-style">
                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/agents/agent-7.jpg" src="https://homelengo.vercel.app/images/agents/agent-7.jpg" alt="image-agent" />
                                                <ul className="agent-social">
                                                    <li><span className="icon icon-facebook"></span></li>
                                                    <li><span className="icon icon-x"></span></li>
                                                    <li><span className="icon icon-linkedin"></span></li>
                                            ...
                                            <div className="content">
                                                <div className="info">
                                                    <h5 className="link"><a className="link" href="#">Wade Warren</a></h5>
                                                    <p className="text-variant-1">Administrative Staff</p>
                                                </div>
                                                <div className="box-icon">
                                                    <span className="icon icon-phone"></span>
                                    ...
                                    <div className="swiper-slide">
                                        <div className="box-agent hover-img wow fadeInUp" data-wow-delay=".5s">
                                            <a href="#" className="box-img img-style">
                                                <img className="lazyload" data-src="https://homelengo.vercel.app/images/agents/agent-8.jpg" src="https://homelengo.vercel.app/images/agents/agent-8.jpg" alt="image-agent" />
                                                <ul className="agent-social">
                                                    <li><span className="icon icon-facebook"></span></li>
                                                    <li><span className="icon icon-x"></span></li>
                                                    <li><span className="icon icon-linkedin"></span></li>
                                            ...
                                            <div className="content">
                                                <div className="info">
                                                    <h5><a className="link" href="#">Devon Lane</a></h5>
                                                    <p className="text-variant-1">Administrative Staff</p>
                                                </div>
                                                <div className="box-icon">
                                                    <span className="icon icon-phone"></span>
                            ...
                            <p className="text-center desc body-2 text-variant-3">Become an agent and get the commission you deserve. <a href="contact.html" className="text-primary"> Contact us</a></p>
                        </div>
                    </section>
                    {/* <!-- End Agents --> */}
                    {/* <!-- Testimonial --> */}
                    <section className="flat-section bg-primary-new flat-testimonial">
                        <div className="box-title px-15">
                            <div className="text-center wow fadeInUp">
                                ...
                                <p className="desc text-variant-1">Our seasoned team excels in real estate with years of successful market navigation, offering informed decisions and optimal results.</p>
                            </div>
                        </div>
                        <div dir="ltr" className="swiper tf-sw-testimonial" data-preview="4.5" data-tablet="2" data-mobile-sm="2" data-mobile="1" data-space="15" data-space-md="30" data-space-lg="30" data-centered="true" data-loop="true">
                            <div className="swiper-wrapper wow fadeInUp" data-wow-delay=".2s">
                                    ...
                                    <div className="box-tes-item">
                                        ...
                                        <div className="box-avt d-flex align-items-center gap-12">
                                            <div className="avatar avt-60 round">
                                                <img src="https://homelengo.vercel.app/images/avatar/avt-png1.png" alt="avatar" />
                                            </div>
                                            <div className="info">
                                                <h6>Courtney Henry</h6>
                                                <p className="caption-2 text-variant-1 mt-4">CEO Themesflat</p>
                                ...
                                <div className="swiper-slide">
                                    <div className="box-tes-item">
                                        ...
                                        <div className="box-avt d-flex align-items-center gap-12">
                                            <div className="avatar avt-60 round">
                                                <img src="https://homelengo.vercel.app/images/avatar/avt-png2.png" alt="avatar" />
                                            </div>
                                            <div className="info">
                                                <h6>Esther Howard</h6>
                                                <p className="caption-2 text-variant-1 mt-4">CEO Themesflat</p>
                                ...
                                <div className="swiper-slide">
                                    <div className="box-tes-item">
                                        ...
                                        <div className="box-avt d-flex align-items-center gap-12">
                                            <div className="avatar avt-60 round">
                                                <img src="https://homelengo.vercel.app/images/avatar/avt-png4.png" alt="avatar" />
                                            </div>
                                            <div className="info">
                                                <h6>Annette Black</h6>
                                                <p className="caption-2 text-variant-1 mt-4">CEO Themesflat</p>
                                ...
                                <div className="swiper-slide">
                                    <div className="box-tes-item">
                                        ...
                                        <div className="box-avt d-flex align-items-center gap-12">
                                            <div className="avatar avt-60 round">
                                                <img src="https://homelengo.vercel.app/images/avatar/avt-png6.png" alt="avatar" />
                                            </div>
                                            <div className="info">
                                                <h6>Bessie Cooper</h6>
                                                <p className="caption-2 text-variant-1 mt-4">CEO Themesflat</p>
                                ...
                                <div className="swiper-slide">
                                    <div className="box-tes-item">
                                        ...
                                        <div className="box-avt d-flex align-items-center gap-12">
                                            <div className="avatar avt-60 round">
                                                <img src="https://homelengo.vercel.app/images/avatar/avt-png3.png" alt="avatar" />
                                            </div>
                                            <div className="info">
                                                <h6>Courtney Henry</h6>
                                                <p className="caption-2 text-variant-1 mt-4">CEO Themesflat</p>
                                ...
                                <div className="swiper-slide">
                                    <div className="box-tes-item">
                                        ...
                                        <div className="box-avt d-flex align-items-center gap-12">
                                            <div className="avatar avt-60 round">
                                                <img src="https://homelengo.vercel.app/images/avatar/avt-png5.png" alt="avatar" />
                                            </div>
                                            <div className="info">
                                                <h6>Courtney Henry</h6>
                                                <p className="caption-2 text-variant-1 mt-4">CEO Themesflat</p>
                    ...
                    <section className="flat-section pt-0">
                        <div className="container2">
                            ...
                            <div dir="ltr" className="swiper tf-sw-partner" data-preview="6" data-tablet="4" data-mobile-sm="3" data-mobile="2" data-space="15" data-space-md="30" data-space-lg="30">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="partner-item">
                                            <svg width="160" height="80" viewBox="0 0 160 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="160" height="80" fill="white" />
                                                <g clipPath="url(#clip0_13428_2167)">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="partner-item">
                                            <svg width="160" height="80" viewBox="0 0 160 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="160" height="80" fill="white" />
                                                <g clipPath="url(#clip0_13428_2256)">
                                                    <mask id="mask0_13428_2256" maskUnits="userSpaceOnUse" x="-16" y="-56" width="194" height="193">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="partner-item">
                                            <svg width="160" height="80" viewBox="0 0 160 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="160" height="80" fill="white" />
                                                <g clipPath="url(#clip0_13428_2347)">
                                                    <path opacity="0.84" fillRule="evenodd" clipRule="evenodd" d="M79.9952 54.3755C88.4901 54.3755 95.379 54.6191 95.379 54.9213C95.379 55.2234 88.4901 55.467 79.9952 55.467C71.5002 55.467 64.6113 55.2234 64.6113 54.9213C64.6113 54.6191 71.5002 54.3755 79.9952 54.3755Z" fill="#B9B9B9" />
                                                    ...
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M67.3301 49.5314H72.816L89.7092 32.5149H92.6602L96.8884 28.2656H79.9952L84.2233 32.5149L67.3301 49.5314Z" fill="#E3E3E3" />
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M92.6602 32.5149V35.4972L78.7374 49.5314H84.2233L92.6602 41.0232L96.8883 45.2724V28.2656L92.6602 32.5149Z" fill="#E3E3E3" />
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M96.8884 32.5149V38.0408L110.821 24.0066H113.772L118 19.7573H101.107L105.325 24.0066L96.8884 32.5149Z" fill="#B9B9B9" />
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M113.772 24.0066V26.9889L91.6733 49.5314H97.1593L113.772 32.5149L118 36.7739V19.7573L113.772 24.0066Z" fill="#B9B9B9" />
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M92.6602 28.2658H87.1743L101.107 14.2315V11.2493L105.325 7V24.0068L101.107 19.7575L92.6602 28.2658Z" fill="#E3E3E3" />
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M101.107 11.2493H98.1461L84.2233 25.2835V19.7575L92.6602 11.2493L88.4418 7H105.325L101.107 11.2493Z" fill="#E3E3E3" />
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M59.2221 49.5316H53.7362L79.9952 22.7398V19.7576L84.2233 15.5083V32.5151L79.9952 28.2658L59.2221 49.5316Z" fill="#B9B9B9" />
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M79.9952 19.7576H77.0442L47.4859 49.5316H42L71.5582 19.7576L67.3301 15.5083H84.2233L79.9952 19.7576Z" fill="#B9B9B9" />
                                                </g>
                                                <defs>
