...
export const initShortcodes = ($) => {
  ...
  var datePicker = function () {
    if ($("#datepicker1").length > 0 && typeof $.fn.datepicker !== 'undefined') {
      $("#datepicker1").datepicker({
        firstDay: 1,
        dateFormat: "dd/mm/yy",
      });
    }
    if ($("#datepicker2").length > 0 && typeof $.fn.datepicker !== 'undefined') {
      $("#datepicker2").datepicker({
        firstDay: 1,
        dateFormat: "dd/mm/yy",
      });
    }
    if ($("#datepicker3").length > 0 && typeof $.fn.datepicker !== 'undefined') {
      $("#datepicker3").datepicker({
        firstDay: 1,
        dateFormat: "dd/mm/yy",
      });
    }
    if ($("#datepicker4").length > 0 && typeof $.fn.datepicker !== 'undefined') {
