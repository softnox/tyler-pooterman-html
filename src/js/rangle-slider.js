export const initRangeSliders = ($) => {
  const rangeSlider1 = document.getElementById("slider-range");
  if (rangeSlider1 && typeof noUiSlider !== 'undefined') {
    ...
    rangeSlider1.noUiSlider.on("update", function (values, handle) {
      const val1 = document.getElementById("slider-range-value1");
      const val2 = document.getElementById("slider-range-value2");
      if (val1) val1.innerHTML = values[0];
      if (val2) val2.innerHTML = values[1];
  ...
  if (rangeSlider2 && typeof noUiSlider !== 'undefined') {
    ...
    rangeSlider2.noUiSlider.on("update", function (values, handle) {
      const val1 = document.getElementById("slider-range-value01");
      const val2 = document.getElementById("slider-range-value02");
      if (val1) val1.innerHTML = values[0];
      if (val2) val2.innerHTML = values[1];
      const minInput = document.getElementsByName("min-value2")[0];
      const maxInput = document.getElementsByName("max-value2")[0];
      if (minInput) minInput.value = moneyFormat2.from(values[0]);
      if (maxInput) maxInput.value = moneyFormat2.from(values[1]);
    });
  }

  const rangeSlider3 = document.getElementById("slider-range3");
  if (rangeSlider3 && typeof noUiSlider !== 'undefined') {
    $(".noUi-handle3").on("click", function () {
      $(this).width(50);
    });
    var moneyFormat3 = wNumb({
      decimals: 0,
      thousand: ",",
      prefix: "$",
    });
    ...
    rangeSlider3.noUiSlider.on("update", function (values, handle) {
      const val1 = document.getElementById("slider-range-value3");
      const val2 = document.getElementById("slider-range-value4");
      if (val1) val1.innerHTML = values[0];
      if (val2) val2.innerHTML = values[1];
      const minInput = document.getElementsByName("min-value3")[0];
      const maxInput = document.getElementsByName("max-value3")[0];
      if (minInput) minInput.value = moneyFormat3.from(values[0]);
      if (maxInput) maxInput.value = moneyFormat3.from(values[1]);
    });
  }

  const rangeSlider4 = document.getElementById("slider-range4");
  if (rangeSlider4 && typeof noUiSlider !== 'undefined') {
    $(".noUi-handle4").on("click", function () {
      $(this).width(50);
    });
    var moneyFormat4 = wNumb({
      decimals: 0,
      thousand: ",",
      postfix: " SqFt",
    });
    ...
    rangeSlider4.noUiSlider.on("update", function (values, handle) {
      const val1 = document.getElementById("slider-range-value03");
      const val2 = document.getElementById("slider-range-value04");
      if (val1) val1.innerHTML = values[0];
      if (val2) val2.innerHTML = values[1];
      const minInput = document.getElementsByName("min-value4")[0];
      const maxInput = document.getElementsByName("max-value4")[0];
      if (minInput) minInput.value = moneyFormat4.from(values[0]);
      if (maxInput) maxInput.value = moneyFormat4.from(values[1]);
    });
  }
};
