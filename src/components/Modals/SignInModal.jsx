...
const SignInModal = () => {
    ...
    // Static users data
    const users = {
        'service.professional@sitescouter.com': {
            password: 'service123',
            role: 'Service Professional',
            name: 'Service'
        },
        'realtor@sitescouter.com': {
            password: 'realtor123',
            role: 'Realtors',
            name: 'Realtor'
        },
        'homeowner@sitescouter.com': {
            password: 'home123',
            role: 'Homeowner',
            name: 'Homeowner'
        }
    ...
    return (
        <>
            {/* <!-- popup login --> */}
            <div className="modal modal-account fade" id="modalLogin" tabIndex="-1" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="flat-account">
                            ...
                            <form className="form-account d-flex align-items-center justify-content-between flex-column" onSubmit={handleLogin}>
                                ...
                                <div className="box w-100">
                                    ...
                                    <fieldset className="box-fieldset">
                                        ...
                                        <div className="text-forgot text-end">
                                            <a href="#modalForgotPassword" data-bs-toggle="modal" data-bs-dismiss="modal">Forgot password</a>
                                        </div>
                                    </fieldset>
                                ...
                                <div className="box box-btn w-100">
                                    {/* <div className="text text-center">Don't you have an account?
                                        <a href="#modalRegister" data-bs-toggle="modal" className="text-primary">Register</a>
                                    </div> */}
                                </div>
                            </form>
                        </div>
